...
class NonEmergencyTicketsScreen extends StatefulWidget {
  @override
  _NonEmergencyScreenState createState() => _NonEmergencyScreenState();
}

class _NonEmergencyScreenState extends State<NonEmergencyTicketsScreen> {
  ...
  Future<void> _fetchTickets() async {
    try {
      ...
      setState(() {
        _tickets = tickets
            .where((ticket) => ticket['jenis_tiket'] == 'Non Emergency')
            .toList();
